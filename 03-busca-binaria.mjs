/*
    ...
    * índica que o valor de busca não existe no conjunto.
*/
...
function buscaBinaria(vetor, valorBusca) {
    ...
    while(fim >= ini) {
        ...
        // Se o valor de busca for igual ao valor do veto
...
console.log('Posiçao de 33:', buscaBinaria(nums, 33), 'comps:', comps)
console.log('Posiçao de 77:', buscaBinaria(nums, 77), 'comps:', comps)
console.log('Posiçao de 81:', buscaBinaria(nums, 81), 'comps:', comps)

/*********************************************************************************/

import { nomes } from './Data/vetor-nomes.mjs'

console.log(`Posição de GABRIEL: ${buscaBinaria(nomes, 'GABRIEL')}, comps: ${comps}`)
