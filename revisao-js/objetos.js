...
let pessoa = {
    ...
    dataNasc: '2000-09-18',
    ocupacao: 'estudande',
    // Quando nomes de propriedade contêm espaços ou
...
// Acrescentano novas propriedades a um objeto existente
...
console.log('------------------------------------------')
console.log('Exibindo so nomes das propriedades do objeto "pessoa"')
...
console.log('------------------------------------------')
console.log('Exibindo so nomes das propriedades do objeto "carro":')
